...
var Enemy = function Enemy(x, y, speed) {
    this.x = x, this.y = y, this.speed = speed, this.sprite = 'images/enemy-bug.png';
};
...
var enemy1 = new Enemy(-400, 60, 1);
var enemy2 = new Enemy(-600, 145, 1);
var enemy3 = new Enemy(-500, 230, 1);
var enemy4 = new Enemy(-280, 145, 1);
